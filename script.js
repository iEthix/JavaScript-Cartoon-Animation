...
updateRocketLaunchCanvas = function () {
  ...
  rocketLaunch.clearRect(
    0,
    0,
    rocketLaunchCanvas.width,
    rocketLaunchCanvas.height
  );
  ...
  drawFlames(
    rocketLaunch,
    rocket.x - 50,
    rocket.y + rocket.height + 20 + rocket.height / 2,
    rocket.width,
    rocket.height / 2,
    0
  );
...
updateRocketFlyingCanvas = function () {
  ...
  rocketFlyingContext.clearRect(
    0,
    0,
    rocketFlyingCanvas.width,
    rocketFlyingCanvas.height
  );
  ...
  var dx = 100 - (rocketFlying.x + 150);
  var dy = 300 - rocketFlying.y;

  var distance = Math.sqrt(dx * dx + dy * dy);
  var directionX = dx / distance;
  var directionY = dy / distance;

  var scaleFactor = Math.max(0.1, distance / 1000);
  ...
  drawRocket(
    rocketFlyingContext,
    rocketFlying.x + 150 * scaleFactor,
    rocketFlying.y,
    rocketFlying.width * scaleFactor,
    rocketRotation
  );
  drawPropeller(
    rocketFlyingContext,
    rocketFlying.x + 138 * scaleFactor,
    rocketFlying.y,
    0.3 * scaleFactor,
    0.3 * scaleFactor,
    rocketRotation
  ...
  drawFlames(
    rocketFlyingContext,
    rocketFlying.x + 190 * scaleFactor,
    rocketFlying.y - 37 * scaleFactor,
    rocketFlying.width * scaleFactor,
    rocketFlying.height * scaleFactor,
    rocketRotation
  );
  drawRocketFins(
    rocketFlyingContext,
    rocketFlying.x + 160 * scaleFactor,
    rocketFlying.y,
    rocketFlying.width * 0.3 * scaleFactor,
    rocketFlying.height * scaleFactor,
    rocketRotation
  );
...
updateRocketMoonLandingCanvas = function () {
  ...
  rocketMoonLandingContext.clearRect(
    0,
    0,
    rocketMoonLandingCanvas.width,
    rocketMoonLandingCanvas.height
  );
  ...
  drawRocketFins(
    rocketMoonLandingContext,
    rocketLanding.x,
    rocketLanding.y + rocketLanding.height / 2,
    67,
    200,
    0
  );
  ...
  if (rocketLanding.y < 235) {
    drawFlames(
      rocketMoonLandingContext,
      rocketLanding.x - 50,
      rocketLanding.y + rocketLanding.height + 20 + rocketLanding.height / 2,
      rocketLanding.width,
      rocketLanding.height / 2,
      0
    );
  }
  ...
  if (rocketLanding.y >= 300 - rocketLanding.height / 2) {
    scene3Finished = true;
    updateRocketMissionCompleteCanvas();
  } else {
...
updateRocketMissionCompleteCanvas = function () {
  ...
  var rocketMissionCompleteContext =
    rocketMissionCompleteCanvas.getContext("2d");

  rocketMissionCompleteContext.clearRect(
    0,
    0,
    rocketMissionCompleteCanvas.width,
    rocketMissionCompleteCanvas.height
  );
